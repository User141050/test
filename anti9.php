...
$newbots_ = array(
	...
	"360Spider",
	"80legs Web Crawler",
	"A Passion For Jazz Media Crawler",
	"Abacho Crawler",
	"Aboundex Crawler",
	"Accoona AI Crawler",
	"Accoona Business Crawler",
	"AdBeat Bot",
	"addthis.com Crawler",
	"ADmantX Platform Semantic Analyzer",
	"Adobe AIR",
	"AdScanner Crawler",
	"Ahrefs Backlink Research Bot",
	"Ahrefs Site Audit Bot",
	"aiHitData Crawler",
	"AlertSite Monitoring Bot",
	"Alexa Bot",
	"Alexa Certification Scanner",
	"Alexa Media Player",
	"Alexa Site Audit",
	"AlienBlue",
	"Alipay",
	"Alpha SEO Crawler",
	"Amaya",
	"Amazon Affiliate Crawler",
	"Ancestry App",
	"Ancestry TreeToGo",
	"AnyApex Web Directory Crawler",
	"Apple Podcast App",
	"Apple RSS Updater",
	"Arachmo Download Manager",
	"Arora",
	"Ask Jeeves Crawler",
	"Asterias Crawler",
	...
	"Baidu Union Spider",
	"Become.com Crawler",
	"Beslist Shopping Crawler",
	"Bibliothèque nationale de France Crawler",
	"Bing Preview Snapshot Generator",
	"Bing Search App",
	"BingBot",
	"Bit.ly Link Checker",
	"Blazer",
	"Blekko Scoutjet Crawler",
	"BLEXBot Crawler",
	"BlitzBot Crawler",
	...
	"Callpod Keeper",
	"Camino",
	"CareerBot Search Crawler",
	"CastBox",
	"CatchBot",
	"Catchpoint Analyser",
	"Charlotte",
	"CheckMark Network Crawler",
	"Chimera",
	"ClamAV Website Scanner",
	"Cliqz.com Crawler",
	"Cloud System Networks Monitoring Bot",
	"Coder Nut",
	"Codewise Bot",
	"collectd Stats collection daemon",
	"CometBird",
	"CommonCrawl Crawler Node",
	"Comodo Dragon",
	"Comodo IceDragon",
	...
	"Cosmos Crawler",
	"Covario Spider",
	"Cuil Twiceler Crawler",
	"cURL",
	"DataparkSearch Engine",
	"Dataprovider Crawler",
	"Daum",
	"DeepCrawl Bot",
	"DeNa Crawler",
	"DeuSu Crawler",
	...
	"Elmedia Player",
	"EmailWolf Crawler",
	"EmeraldShield.com Filter",
	"EnliteAI Bot",
	"Envolk Spider",
	"Epiphany",
	"ESPN: Sports News & Highlights App",
	"Evaliant Impressions Bot",
	"Exalead CloudView Crawler",
	"ExaLead Crawler",
	"ExaLead Image Crawler",
	"ExB Language Crawler",
	"Excel",
	"Exensa Crawler",
	"F-Secure Riddler Crawler",
	"Facebook App",
	"Facebook Bot",
	"Facebook Gameroom",
	"FAST Enterprise Crawler",
	"FAST Fresh Crawler",
	"FAST MetaData Crawler",
	"Fast Web Crawler",
	"FindLinks Crawler Bot",
	"Firebird",
	"Flamingo Crawler",
	"Flashfire",
	"Flipboard",
	...
	"Flow",
	"Fluid",
	"Fluid Dynamics Search Engine Crawler",
	"FrontPage",
	"Galeon",
	"Genieo Bot",
	"Gigablast Crawler",
	"Gnip UnwindFetchor Crawler",
	"Go Http Client",
	"GO HttpClient",
	"GomezAgent",
	"Goo Crawler",
	"Google AdsBot",
	"Google API Notification Push Agent",
	...
	"Google Image Proxy",
	"Google Lighthouse",
	"Google Mobile AdsBot",
	"Google Read Aloud",
	"Google Search App",
	"Google Site Verifier Bot",
	"Google Structured Data Testing Tool",
	"Google Web Preview Analytics Crawler",
	"Google WebLight Proxy",
	"Google's Media Partners system (AdSense)",
	"Google+ Snippet Fetcher",
	"Googlebot",
	"Googlebot Image Crawler",
	"Googlebot Mobile",
	"Googlebot News Crawler",
	"Googlebot Video Crawler",
	"Grapeshot Bot",
	"Grindr",
	"GRUB Distributed Internet Crawler",
	"GTmetrix Analyser",
	"GuzzleHttp",
	"Haiku Learning",
	"Headless Chrome",
	...
	"Iceape",
	"Iceweasel",
	"Ideal Observer Analytics",
	"Import.io Bot",
	"InfoBot",
	"Instagram",
	"Internet Archiver Bot",
	"Internet Channel",
	"Internet Explorer",
	"Internet Explorer Mobile",
	"Internet Memory Crawler",
	"Internet Surfboard",
	"Iris",
	"iTunes",
	...
	"Mail.ru Crawler",
	"Majestic-12 Distributed Search Bot",
	"MaxPoint Crawler",
	"Maxthon",
	"MeanPath Bot",
	"Media Toolkit Crawler",
	"MegaIndex Crawler",
	"MegaUpload Bot",
	"MetaJob Crawler",
	"Microsoft CryptoAPI",
	"Microsoft WebDAV HTTP File Request",
	...
	"OpenLink Profiler SEO Analyser Bot",
	"OpenSite Explorer Crawler",
	"OpenSiteExplorer Crawler",
	"Openstat.com Crawler",
	"OpenVAS Scanner",
	"Orange.com Crawler",
	"Orca",
	"OutClicks.net Crawler",
	"Outform Digital Display",
	"Outlook",
	"Outlook Calendar",
	"Outlook Express",
	"Outlook Mail",
	...
	"PHPCrawl",
	"Picsearch Crawler",
	"Picsearch Image Crawler",
	"Picsearch Page Crawler",
	"Pingdom Bot",
	"Pinterest App",
	"Pinterest Bot",
	"Plucker Spider",
	...
	"Project",
	"Proximic Search",
	"Public Library Archive Crawler",
	"Publisher",
	"Puffin",
	...
	"Qihoo 360",
	"QQ Download Manager",
	"QQDownload Download Manager",
	"Qualys SSL Assessment Scanner",
	"QupZilla",
	"Qwantify Search Crawler",
	"Raptr",
	"Reactor Netty",
	"Rekonq",
	"RestSharp",
	...
	"RSSOwl",
	"RuxitSynthetic",
	"Safari Search Suggestions Helper",
	"Safepay",
	...
	"SecondLife",
	"Seekport Crawler",
	"Semantic Visions Crawler",
	"SEMRush Crawler",
	"SEO Scanners Crawler Bot",
	"SEOkicks Crawler",
	"SeznamBot Crawler",
	"Shiretoko",
	"Silk",
	...
	"Songbird",
	"Sonos Player",
	"Sosospider Search Bot",
	"SpeedCurve Speed Tester",
	"Splash",
	"Spotify",
	"SprayCan",
	"Squider Bot",
	"SRWare Iron",
	"Stagefright Based System",
	"StartMe Bot",
	"Statdom Crawler",
	"Surf",
	"Tableau Desktop",
	...
	"TenFourFox",
	"Teoma Crawler",
	"The Trade Desk Content Scraper",
	"Tiny Tiny RSS",
	"Topsy Butterfly Robot",
	"Turnitin Crawler",
	"TweetMeme Bot",
	"Twitter App",
	"TwitterBot",
	...
	"Unknown bot",
	"updown.io Favicon Crawler",
	"updown.io monitoring bot",
	"Uptime Bot",
	"Uptime Robot",
	"Valve Steam Game Overlay",
	"Valve Steam Tenfoot Display",
	"Vebidoo Crawler",
	"Velen Crawler",
	"Viber",
	"Vienna",
	...
	"Yahoo Link Preview",
	"Yahoo Mail Proxy",
	"Yahoo! Japan Crawler Bot",
	"Yahoo! Multimedia Crawler Bot",
	"Yahoo! Slurp Web Crawler Bot",
	"Yandex Image Bot",
	"Yandex Metrika Search Bot",
	"Yandex Search Bot",
	"Yelp Crawler Bot",
	"YodaoBot Search Bot",
	"ZGrab",
...
foreach ($newbots_ as $newww) {
    if (substr_count($_SERVER['HTTP_USER_AGENT'], $newww) > 0) {
        header('Location: https://www.google.com/search?q='.$settings['out']);
    }
}
